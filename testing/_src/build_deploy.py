...
if os.path.exists(_holo):
    ...
    # be regenerated by anyone, and the nineteen ships imported on 2026-08-27
    # are absent from it. That is why they show no dots: not a marker bug, a
    # missing record, and a generator nobody has.
    #
