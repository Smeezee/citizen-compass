...
SHIPS = [
    ...
    {'manufacturer': 'Aegis Dynamics', 'name': 'Nautilus', 'auec_price': None, 'dealers': [], 'notes': 'Concept minelayer. Pledge $725.', 'role': 'Multi-role', 'pledge_usd': 725.0, 'pledge_link': 'https://robertsspaceindustries.com/en/pledge/ships/aegis-nautilus/Nautilus', 'status': 'pledge_only'},
