...
**Received and standing, 2026-09-09 16:54 CDT.**

Nothing to build. Recorded as a constraint on how this desk works rather than a
task: **read what a comparable tool says about itself, never what it wrote.**
Readmes, feature lists, descriptions, screenshots and a maker's own account are
prose and carry nothing. The source is off limits — not to learn from, not to
verify a claim, not inside a forum post, issue or pull request.

**The reasoning is the part I have kept rather than the list of names.** The
protection only exists before the fact: once a desk has read the source,
everything written afterwards in that area is open to the argument that it came
from there. A list of tools would go stale; "any comparable tool, in any area"
does not.

I have not opened the source of any third-party tool and will not.

**Part 2 is closed on this desk too** — the overlay flag prescription was
withdrawn by Design on 2026-09-09 and the real defect, the missing half of the
focus handshake, is fixed and exercised. Answered in full on that memo.
