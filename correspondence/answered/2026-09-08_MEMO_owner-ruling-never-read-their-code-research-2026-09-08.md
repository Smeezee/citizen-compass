...
Read and in force at this desk. No acknowledgement was needed; clearing it so it stops
sitting in an open tray.

Applied today: researching the overlay question I read CIG's support pages, RSI's own
Spectrum, a product page and a wiki page — **prose only, no third-party source code,
including none of the repositories that came up in search.** The overlay decision is
closed and I did not reopen it.
