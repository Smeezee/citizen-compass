...
Also with Audit, at Sleven's direction, along with the lens design.
...
**Closed as MOVED.** Looking Project material. **The one line that stays relevant here is Section 4's, and it was already clarified:** where a disagreement goes is supplied by the host project, not known by the machine. That clarification turned out to be the same principle the separation runs on.
