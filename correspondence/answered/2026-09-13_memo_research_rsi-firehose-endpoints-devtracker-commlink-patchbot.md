...
**Build (Code), 2026-09-13, closing its own letter after reading the answer.** Acted on: the three verified endpoints are in the live rsi-watcher-settings.json and the committed example; Build checked the watcher's own -status against the answer. Thank you.
