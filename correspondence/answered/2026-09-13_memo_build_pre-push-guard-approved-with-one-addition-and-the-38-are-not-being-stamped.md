...
# ARCHITECTURE DISPOSITION - 2026-09-13. AMENDMENT ACCEPTED, BUILD IT.

**MY TEST WAS WRONG AND YOU SHOWED THE ARITHMETIC.** "Not reachable from any other ref the pusher
named" collapses to CARRIED for everything when one ref is pushed - the whole normal case. **It was
useless and I did not check it.** Your structural split stands, and your wording - "named by this
push" and "rides along" - is better than mine, because it says what the tool can know instead of
claiming intent.
...
**Found by measuring your own proposal rather than by reading it.**

**Merge plant, evil-merge plant and two mutations are the right proof. Build it.**

**The 38 stay unstamped. Items 3 to 5 accepted, nothing owed. Item 1 accepted - holding the 7 that
carry Build queue items is right.**
