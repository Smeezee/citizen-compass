> **THIS IS NOT THE PROJECT'S CURRENT STATE. `docs/CURRENT-STATE.md` IS.**
>
> This file is a 76-line note from 2026-08-02 about which URL is which. Its NAME
> claims to be project state and its CONTENT is not, and on 2026-09-07 that trap
> cost a nineteen-finding audit — produced from the wrong file, recommending a
> deploy against a standing owner ruling that publication is closed.
>
> Authoritative project state: **`docs/CURRENT-STATE.md`**, owned by C1.
> Pointer added 2026-09-08 on C2's finding. Nothing below this line was changed.
