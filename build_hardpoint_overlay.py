...
def main():
    ...
    for f in sorted(os.listdir(PLACE)):
        ...
        if not key:
            ...
            # `place_fleet.py` - and THAT SCRIPT IS AT data-layer/derived/holo-hardpoints/place_fleet.py -- THIS COMMENT SAID "NOT IN THIS REPOSITORY" AND WAS WRONG, see ERRATUM 2026-08-29. It is runnable; the records below were still added additively and that part stands. So. So
