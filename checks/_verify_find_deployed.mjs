...
/* THE GENERATOR NAMES ITSELF IN _src AND DELIBERATELY NOT IN _deploy.
   This required the header on the SERVED file until 2026-08-30. Q31 removes it:
   "GENERATED by build_find_data.py" names a build script and the repo layout on
   a public URL, and Sleven's instruction is that nothing public hints at how the
   site was built. The two requirements were in direct conflict and the
   instruction wins.
   _verify_find_page.mjs made the same move for the local copy; this is its
   deployed sibling and was missed then - the second half of a pair, again. */
record(!/GENERATED by/.test(data.body),
  "the served data file does NOT name its generator (Q31)");
